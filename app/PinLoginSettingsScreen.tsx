...
import { savePIN, getPIN, savePINEnabled, isPinEnabled, getCurrentUser } from "./storage";
...
export default function PinLoginSettingsScreen() {
  ...
  const handleTogglePIN = async () => {
    ...
    await savePINEnabled(!pinEnabled, userId);
    setPinEnabled(!pinEnabled);
    Alert.alert(`PIN login ${!pinEnabled ? "enabled" : "disabled"}`);
  };
